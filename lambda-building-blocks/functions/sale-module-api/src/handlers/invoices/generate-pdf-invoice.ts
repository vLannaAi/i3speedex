/**
 * Generate PDF Invoice Handler
 * POST /api/sales/{id}/invoice/pdf
 *
 * Generate PDF invoice for a sale (HTML → PDF)
 */
...
import { renderTemplate, convertHtmlToPdf } from '../../common/clients/lambda';
import { uploadInvoicePDF } from '../../common/clients/s3';
...
export async function handler(event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> {
  ...
  try {
    ...
    // 13. Update sale with invoice generation info
